...
! Executable code
   ...
   do i = 1,seeds%N
      ...
      seeds%fz_bin_inner(i) = seeds%rbin(i) !ringmoons_ring_bin_finder(ring,seeds%a(i) - fz_width(i))
      seeds%fz_bin_outer(i) = seeds%rbin(i) !ringmoons_ring_bin_finder(ring,seeds%a(i) + fz_width(i))
   end do
