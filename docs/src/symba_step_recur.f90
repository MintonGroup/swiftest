               ...
               DO i = 1, nplplenc
                    ...
                    IF (((plplenc_list%status(i) == ACTIVE) .AND.                                                                 &
                        ...
                        ! Determines if close encounter leads to merger if lfrag=.FALSE.   
                         ...
                         ELSE
                            CALL symba_merge_pl(t, dt, index_enc, nplplenc, plplenc_list, nmergeadd, nmergesub, mergeadd_list, mergesub_list, eoffset, &
               ...
               DO i = 1, npltpenc
                    ...
                    IF ((pltpenc_list%status(i) == ACTIVE) .AND.                                          &
                        ...
                        (symba_tpA%levelg(index_tp) >= ireci)) THEN                                          
                         CALL symba_merge_tp(t, dt, index_enc, pltpenc_list, vbs, encounter_file, out_type, symba_plA, symba_tpA)                    !check later 
                    END IF
               END DO
          END IF
          DO i = 1, nplplenc
                    ...
                    DO i = 1, nplplenc
                         ...
                         IF ((plplenc_list%status(i) == ACTIVE) .AND.                                                             &
                             ...
                             (symba_plA%levelg(index_j) >= ireci))  THEN    
                              ...
                              ELSE
                                   CALL symba_merge_pl(t, dt, index_enc, nplplenc, plplenc_list, nmergeadd, nmergesub, &
                    ...
                    DO i = 1, npltpenc
                         ...
                         IF ((pltpenc_list%status(i) == ACTIVE) .AND.                                                             &
                             ...
                             (symba_tpA%levelg(index_tp) >= ireci))                                                               &
                              CALL symba_merge_tp(t, dt, index_enc, pltpenc_list, vbs, encounter_file, out_type, symba_plA,&
                                    symba_tpA)
                    END DO
               END IF
               DO i = 1, nplplenc
