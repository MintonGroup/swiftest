...
! Internals
     LOGICAL(LGT)              :: lmerge
     INTEGER(I4B)              :: i, j, k, id1, id2, stat1, stat2, nres,model,regime, collresolve_resolve
     REAL(DP)                  :: r2, rlim, rlim2, vdotr, tcr2, dt2, mtot, a, e, q, m1, m2, mtmp, mmax, eold, enew, rad1, rad2, & 
     mass1, mass2
     REAL(DP), DIMENSION(NDIM) :: xr, vr, x1, v1, x2, v2, xnew, vnew, mres, rres
     REAL(DP), DIMENSION(NDIM,NDIM) :: pres, vres
