...
MODULE module_interfaces
     ...
     INTERFACE
          SUBROUTINE coord_vb2vh(npl, swiftest_pl1P)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: npl
     ...
     INTERFACE
          SUBROUTINE coord_vb2vh_tp(ntp, swiftest_tp1P, vs)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)              :: ntp
     ...
     INTERFACE
          SUBROUTINE coord_vh2vb(npl, swiftest_pl1P, msys)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: npl
     ...
     INTERFACE
          SUBROUTINE coord_vh2vb_tp(ntp, swiftest_tp1P, vs)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)              :: ntp
     ...
     INTERFACE
          SUBROUTINE discard(t, dt, npl, ntp, swiftest_pl1P, swiftest_tp1P, rmin, rmax, rmaxu, qmin, qmin_alo, qmin_ahi,            &
     ...
     INTERFACE
          SUBROUTINE discard_peri(t, npl, ntp, swiftest_pl1P, swiftest_tp1P, msys, qmin, qmin_alo, qmin_ahi, qmin_coord,            &
               lrhill_present)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE helio_drift(npl, swiftest_pl1P, dt)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: npl
     ...
     INTERFACE
          SUBROUTINE helio_drift_tp(ntp, swiftest_tp1P, mu, dt)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: ntp
     ...
     INTERFACE
          SUBROUTINE helio_getacch_int_tp(npl, ntp, swiftest_pl1P, helio_tp1P, xh)
               USE module_parameters
               USE module_swiftest
               USE module_helio
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE helio_lindrift(npl, swiftest_pl1P, dt, pt)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)               :: npl
     ...
     INTERFACE
          SUBROUTINE helio_lindrift_tp(ntp, swiftest_tp1P, dt, pt)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)              :: ntp
     ...
     INTERFACE
          SUBROUTINE io_dump_pl(npl, swiftest_pl1P, lclose, lrhill_present)
               USE module_parameters
               USE module_swiftest
               USE module_fxdr
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE io_dump_tp(ntp, swiftest_tp1P)
               USE module_parameters
               USE module_swiftest
               USE module_fxdr
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE io_init_pl(inplfile, in_type, lclose, lrhill_present, npl, swiftest_pl1P)
               USE module_parameters
               USE module_swiftest
               USE module_fxdr
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE io_init_tp(intpfile, in_type, ntp, swiftest_tp1P)
               USE module_parameters
               USE module_swiftest
               USE module_fxdr
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE io_write_frame(t, npl, ntp, swiftest_pl1P, swiftest_tp1P, outfile, out_type, out_form, out_stat)
               USE module_parameters
               USE module_swiftest
               USE module_fxdr
               IMPLICIT NONE
     ...
     INTERFACE
          SUBROUTINE obl_acc(npl, swiftest_pl1P, j2rp2, j4rp4, xh, irh, aobl)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)                    :: npl
     ...
     INTERFACE
          SUBROUTINE obl_pot(npl, swiftest_pl1P, j2rp2, j4rp4, xh, irh, oblpot)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)                   :: npl
     ...
     INTERFACE
          SUBROUTINE symba_setup(npl, ntp, symba_plA, symba_tpA, symba_pl1P, symba_tp1P, swiftest_pl1P, swiftest_tp1P)
               USE module_parameters
               USE module_swiftest
               USE module_helio
               USE module_symba
...
! FOR TESTING PURPOSES ONLY _ USE WITH SYMBA_STEP_TEST
     ...
     INTERFACE
          SUBROUTINE util_hills(npl, swiftest_pl1P)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: npl
     ...
     INTERFACE
          SUBROUTINE util_peri(lfirst, ntp, swiftest_tp1P, mu, msys, qmin_coord)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               LOGICAL(LGT), INTENT(IN)  :: lfirst
     ...
     INTERFACE
          SUBROUTINE util_valid(npl, ntp, swiftest_pl1P, swiftest_tp1P)
               USE module_parameters
               USE module_swiftest
               IMPLICIT NONE
               INTEGER(I4B), INTENT(IN)  :: npl, ntp
