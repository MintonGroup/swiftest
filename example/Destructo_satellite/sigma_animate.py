...
class AnimatedScatter(object):
    ...
    def __init__(self):
        ...
        self.ani = animation.FuncAnimation(self.fig, self.update, interval=100, frames=46000,
    ...
    def setup_plot(self):
        ...
        self.RRLlab = self.ax.text(ic.RRL / ic.RP - 0.20, 0.2 * ymax, "RRL", rotation=90, fontsize="10")
        self.FRL = self.ax.plot([ic.FRL / ic.RP, ic.FRL / ic.RP], [ymin, ymax], ':', color="black", linewidth=0.5, zorder=50)
        self.FRLlab = self.ax.text(ic.FRL / ic.RP - 0.20, 0.2 * ymax, "FRL", rotation=90, fontsize="10")
        self.Rsync = self.ax.plot([ic.Rsync / ic.RP, ic.Rsync / ic.RP], [ymin, ymax], '-.', color="black", linewidth=0.5, zorder=50)
        self.Rsynclab = self.ax.text(ic.Rsync / ic.RP - 0.20, 0.2 * ymax, "$a_{sync}$", rotation=90, fontsize="10")
