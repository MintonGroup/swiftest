...
r_pdisk = 25.e0 / DU2CM #disk particle size
rho_pdisk = 1.5 * DU2CM**3 / MU2GM # Satellite/ring particle mass density in gm/cm**3
...
Nseeds   = 0
sigma_peak = 1050000 * DU2CM**2 / MU2GM
sigma_slope = -8.0
Gmseed = np.array([GU * 1.2e23 / MU2GM])
aseed = np.array([0.9999*RRL])
