...
xlim = {"aescatter": (0.0, 3.0), "aiscatter": (0.0, 3.0), "arotscatter": (0.0, 2.5)}
ylim = {"aescatter": (0.0, 1.0), "aiscatter": (0.0, 40.0), "arotscatter": (1.0, 10000.0)}
xlabel = {"aescatter": "Semimajor axis (AU)", "aiscatter": "Semimajor axis (AU)", "arotscatter": "Semimajor axis (AU)"}
ylabel = {"aescatter": "Eccentricity", "aiscatter": "Inclination (deg)", "arotscatter": "Rotation period (h)"}
...
class AnimatedScatter:
    ...
    def __init__(self, ds, param):
        ...
        self.clist = dict(zip(origin_types, colors, strict=False))
    ...
    def make_artists(self):
        ...
        self.scatter_artist_names = dict(zip(origin_types, scatter_names, strict=False))
