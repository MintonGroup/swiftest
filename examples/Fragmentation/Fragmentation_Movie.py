...
movie_title_list = [
    "Head-on Disruption",
    "Off-axis Disruption",
    "Head-on Supercatastrophic",
    "Off-axis Supercatastrophic",
    "Hit and Run w/ Runner Disruption",
    "Pure Hit and Run",
    "Merge",
    "Merge crossing the spin barrier",
]
movie_titles = dict(zip(available_movie_styles, movie_title_list, strict=False))
...
rot_vectors = {
    "disruption_headon": [np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 0.0])],
    "disruption_off_axis": [np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 0.0])],
    "supercatastrophic_headon": [np.array([0.0, 0.0, 0.0e0]), np.array([0.0, 0.0, 0.0e0])],
...
class AnimatedScatter:
    ...
    def __init__(self, sim, animfile, title, style, nskip=1):
        ...
        self.title = title
        self.body_color_list = {
            "Initial conditions": "xkcd:windows blue",
        ...
        self.ani = animation.FuncAnimation(
            self.fig, self.update_plot, init_func=self.init_func, interval=1, frames=range(0, num_movie_frames, nskip), blit=True
        )
    ...
    def data_stream(self, frame=0):
        while True:
            ...
            rh = ds["rh"].values
            rotangle = np.deg2rad(ds["rotangle"].values)
