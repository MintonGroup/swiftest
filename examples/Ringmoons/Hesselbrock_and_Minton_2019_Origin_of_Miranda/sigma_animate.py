...
class AnimatedScatter:
    ...
    def __init__(self):
        ...
        nframes = self.sim.data.time.size
        frames = tqdm(
            range(nframes),
            file=sys.stdout,
        ...
        self.ax.set_xlabel(r"Distance to Uranus ($R_U$)", fontsize="12")
        ...
        self.ani.save("Hesselbrock_and_Minton_2019_Origin_of_Miranda.mp4", fps=60, dpi=600, extra_args=["-vcodec", "libx264" ])
        return
