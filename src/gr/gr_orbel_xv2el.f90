...
!    File      : none
!
!  Invocation  : CALL orbel_xv2el(x, pv, mu, a, e, inc, capom, omega, capm, c2)
!
...
!
!                Includes relativistic correction based on Saha & Tremaine (1994)
!**********************************************************************************************************************************
SUBROUTINE orbel_xv2el(x, pv, mu, a, e, inc, capom, omega, capm, c2)
...
! Executable code
     ...
     omega = 0.0_DP
     capm = 0.0_DP
     CALL gr_pseudovel2vel(x,pv,mu,c2,v)
