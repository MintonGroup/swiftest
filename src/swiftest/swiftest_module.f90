...
module swiftest
   ...
   type, extends(base_io_netcdf_parameters) :: swiftest_io_netcdf_parameters
   contains
   ...
   end type swiftest_io_netcdf_parameters
   ...
   interface
      ...
      module subroutine swiftest_kick_getacch_int_all_tp(ntp, npl, xtp, xpl, GMpl, lmask, acc)
         implicit none
