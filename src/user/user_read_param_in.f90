   ...
   do
      ...
      if ((ilength /= 0)) then 
         ...
         case ("CHK_QMIN_RANGE")
            ...
            ifirst = ilast + 1
            param_value = user_get_token(line, ifirst, ilast, ierr)
